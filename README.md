...
Similar syntax is followed for state level too. 

Ex: data/aggregated/transaction/country/india/state/delhi/2018/1.json
...
Ex: data/aggregated/user/country/india/state/delhi/2021/1.json
...
Similar syntax is followed for district level too. 

Ex: data/map/transaction/hover/country/india/state/delhi/2021/1.json
...
Ex: data/map/user/hover/country/india/state/delhi/2021/1.json
...
**NOTE**: 
Similar syntax is followed for state level too. The only exception is, it won't have data for states.

**Ex: data/top/transaction/country/india/state/delhi/2021/1.json**
...
Ex: data/top/user/country/india/state/delhi/2021/1.json
