...
repo_name = "Phonepe Pulse data"
clone_dir = "C:/PhonepePulse"

# Clone the repository to the specified local directory
#subprocess.run(["git", "clone", clone_url, clone_dir], check=True)
path_1 = "C:/PhonepePulse/data/aggregated/transaction/country/india/state/"
...
path_2 = "C:/PhonepePulse/data/aggregated/user/country/india/state/"
...
path_3 = "C:/PhonepePulse/data/map/transaction/hover/country/india/state/"
...
path_4 = "C:/PhonepePulse/data/map/user/hover/country/india/state/"
...
path_5 = "C:/PhonepePulse/data/top/transaction/country/india/state/"
...
path_6 = "C:/PhonepePulse/data/top/user/country/india/state/"
...
engine = create_engine('mysql+mysqlconnector://root:Yashika2016$@localhost/phonepe_pulse', echo=False)
...
conn = pymysql.connect(host='localhost', user='root', password='Yashika2016$', db='phonepe_pulse')
cursor = conn.cursor()
...
# Title
st.header(':violet[Phonepe Pulse Data Visualization - India’s first of its kind interactive geospatial site]')
